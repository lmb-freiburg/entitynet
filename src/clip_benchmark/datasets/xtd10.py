...
GITHUB_DATA_PATH = (
    "https://raw.githubusercontent.com/adobe-research/Cross-lingual-Test-Dataset-XTD10/main/XTD10"
)
GITHUB_MIC_DATA_PATH = (
    "https://raw.githubusercontent.com/adobe-research/Cross-lingual-Test-Dataset-XTD10/main/MIC"
)
GITHUB_STAIR_DATA_PATH = (
    "https://raw.githubusercontent.com/adobe-research/Cross-lingual-Test-Dataset-XTD10/main/STAIR"
)
SUPPORTED_LANGUAGES = [
    "de",
    "en",
...
class XTD10(VisionDataset):
    def __init__(self, root, ann_file, transform=None, target_transform=None):
        ...
        with codecs.open(ann_file, "r", encoding="utf-8") as fp:
            data = json.load(fp)
        self.data = [
            (img_path, txt) for img_path, txt in zip(data["image_paths"], data["annotations"])
        ]
...
def create_annotation_file(root, lang_code):
    ...
    match lang_code:
        ...
        case _:
            captions_path = GITHUB_DATA_PATH
    download_path = os.path.join(captions_path, CAPTIONS_FILENAME_TEMPLATE.format(lang_code))
