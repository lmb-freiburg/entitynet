...
EN_ZSCLS_TEMPLATES = {
    ...
    "food101": ["a photo of {c}, a type of food."],
    "sun397": ["a photo of a {c}.", "a photo of the {c}."],
    "cars": [
        "a photo of a {c}.",
        "a photo of the {c}.",
        "a photo of my {c}.",
    ...
    "pets": ["a photo of a {c}, a type of pet."],
    "inat19": ["a photo of a {c}.", "{c}."],
    "caltech101": [
        "a photo of a {c}.",
        "a painting of a {c}.",
        "a plastic {c}.",
    ...
    "flowers": ["a photo of a {c}, a type of flower."],
    "mnist": ['a photo of the number: "{c}".'],
    "stl10": ["a photo of a {c}.", "a photo of the {c}."],
    "eurosat": [
    ...
    "renderedsst2": ["a {c} review of a movie."],
    "voc2007": ["a photo of a {c}."],
    "voc2007_multilabel": ["a photo of a {c}."],
    "fer2013": [
    ...
    "clevr_count_all": ["a picture of {c} objects"],
    "clevr_closest_object_distance": ["{c} shapes."],
    "pcam": ["a histopathology slide showing {c}", "histopathology image of {c}"],
    "svhn": [
    ...
    "kitti_closest_vehicle_distance": ["{c}"],
    ...
    "dsprites_label_x_position": ["an object located at position {c}% on the horizontal axis"],
    ...
    "dummy": ["a photo of a {c}"],
}

# some are missing, just guess them as imagenet
EN_ZSCLS_TEMPLATES["cub"] = deepcopy(EN_ZSCLS_TEMPLATES["imagenet1k"])
