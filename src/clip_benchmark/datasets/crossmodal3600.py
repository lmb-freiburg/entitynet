...
IMAGES_DOWNLOAD_URL = "https://open-images-dataset.s3.amazonaws.com/crossmodal-3600/images.tgz"
...
def _download_captions(out_path):
    ...
    print(f"Downloading captions to {out_path}")
...
def _download_images(out_path):
    os.makedirs(out_path, exist_ok=True)
    print(f"Downloading images to {out_path}")
